 ...
 * 
 */
@WebServiceClient(name = "HelloworldService", targetNamespace = "http://soapService.spring.wangshibiao.com/", wsdlLocation = "http://localhost:8081/ws/helloworld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://soapService.spring.wangshibiao.com/", "HelloworldService");
    ...
    public Helloworld getHelloworldPort() {
        return super.getPort(new QName("http://soapService.spring.wangshibiao.com/", "HelloworldPort"), Helloworld.class);
    }
    ...
    public Helloworld getHelloworldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapService.spring.wangshibiao.com/", "HelloworldPort"), Helloworld.class, features);
    }
